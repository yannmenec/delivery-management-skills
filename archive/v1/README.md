...
[![Skills: 21](https://img.shields.io/badge/skills-21-green.svg)](#skill-library)
...
```mermaid
graph LR
    Input["Your Data<br/>(paste, mock, or live)"] --> Skills["21 Skills<br/>detect, compute,<br/>generate, evaluate"]
...
- **21 skills** across 7 categories: sprint operations, risk management, reporting, planning, communication, meeting prep, and quality gates
...
| [detect-dependency-risk](skills/sprint-operations/detect-dependency-risk/) | Cross-team dependency risk detection with cascading chain analysis |
